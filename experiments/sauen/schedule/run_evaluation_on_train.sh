...
srun python src/evaluation/evaluate_predictions.py -p experiments/sauen/predictions/finetuning_on_3512a1_2x3_with_handlabeled_bboxs/train/20230720_Sauen_3512a1_2x3-tile-rendered.csv -l experiments/sauen/labels/edited_annotations_120m_1240px_3512a1_2x3/20230720_Sauen_3512a1_2x3-tile-rendered.csv -t 0.4 -e $EXPORT_FOLDER

# evaluate single finetuning predictions
echo "Evaluating performance of RetinaNet with single-stage fine-tuning (3512a1_2x3 with computed bboxs) on train set ..."
srun python src/evaluation/evaluate_predictions.py -p experiments/sauen/predictions/finetuning_on_3512a1_2x3_with_computed_bboxs/train/20230720_Sauen_3512a1_2x3-tile-rendered.csv -l experiments/sauen/labels/edited_annotations_120m_1240px_3512a1_2x3/20230720_Sauen_3512a1_2x3-tile-rendered.csv -t 0.4 -e $EXPORT_FOLDER
